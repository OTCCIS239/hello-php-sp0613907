...
<body>
    ...
    <div class="container">
        ...
        <p>Fortunately, I won't be distracted from my homework by my favorite movie (<?= $movie ?>) or my favorite food (<?= $food ?>) or my favorite tv show (<?= $tvShow ?>)</p>
        <p> because I'm petrified of my teacher.</p>
